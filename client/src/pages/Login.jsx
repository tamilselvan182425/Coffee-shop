        ...
        <div className="container mx-auto px-4 py-20 flex justify-center">
            <div className="w-full max-w-md bg-white rounded-[40px] shadow-2xl overflow-hidden">
                <div className="px-10 pt-12 text-center">
                    <h2 className="text-4xl font-black text-coffee-950 mb-3">Hello Again!</h2>
                    <p className="text-coffee-600 mb-10">Sign in to your account</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="px-10 pb-12">
                    ...
                    <div className="mt-10 text-center">
                        <p className="text-coffee-500 text-sm">
                            ...
                            <Link to="/register" className="text-coffee-700 font-bold hover:underline">Create Account</Link>
                        </p>
                    </div>
                </form>
            </div>
